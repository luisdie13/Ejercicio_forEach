...
en la consola. Exploremos la sintaxis para invocar a .forEach().
    ...
    + El bucle .forEach() recorre la matriz y ejecuta la función de 
...
/*También podemos definir una función de antemano para utilizarla
...
Los tres fragmentos de código hacen lo mismo. En cada método de 
...
preferencias estilísticas, no obstante, debido a la fuerte adopción de
ES6, utilizaremos la sintaxis de funciones de flecha en los ejercicios
posteriores. 
*/

/*Ejercicio: 
  Itera sobre la matriz fruits para registrar 'I want to eat a ' más el nombre
